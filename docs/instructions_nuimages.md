...
# Introduction
In nuImages, we annotate objects with 2d boxes, instance masks and 2d segmentation masks. All the labels and attributes from VOD are carried over into nuImages.
...
# Objects
nuImages contains the [same object classes as VOD](https://github.com/nutonomy/vod-devkit/tree/master/docs/instructions_vod.md#labels),
while the [attributes](#attributes) are a superset of the [attributes in VOD](https://github.com/nutonomy/vod-devkit/tree/master/docs/instructions_vod.md#attributes).

## Bounding Boxes
### General Instructions
 - Draw bounding boxes around all objects that are in the list of [object classes](https://github.com/nutonomy/vod-devkit/tree/master/docs/instructions_vod.md#labels).
...
![bboxes_occlusion_1](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/bboxes_occlusion_1.png) 
![bboxes_occlusion_2](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/bboxes_occlusion_2.png)
...
![bboxes_reflection](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/bboxes_reflection.png) 
...
![bboxes_extremity_1](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/bboxes_extremity_1.png)
![bboxes_extremity_2](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/bboxes_extremity_2.png)
...
![bboxes_pedestrian_nighttime_fp_1](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/bboxes_pedestrian_nighttime_fp_1.png) 
![bboxes_pedestrian_nighttime_fp_2](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/bboxes_pedestrian_nighttime_fp_2.png)
 - `vehicle.*`
...
![bboxes_vehicle_nighttime_fp_1](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/bboxes_vehicle_nighttime_fp_1.png)
![bboxes_vehicle_nighttime_fp_2](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/bboxes_vehicle_nighttime_fp_2.png)
![bboxes_vehicle_nighttime_fn_1](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/bboxes_vehicle_nighttime_fn_1.png)
...
![instanceseg_occlusion5pix_1](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/instanceseg_occlusion5pix_1.png)
...
![instanceseg_covered](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/instanceseg_covered.png)
...
![instanceseg_hole_another_object](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/instanceseg_hole_another_object.png)
...
![instanceseg_hole_another_object_exempt](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/instanceseg_hole_another_object_exempt.png)
 - If a static / moveable object has another object attached to it (signboard, rope), include it in the annotation.
 
![instanceseg_attached_object_1](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/instanceseg_attached_object_1.png)
...
![instanceseg_guess](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/instanceseg_guess.png)
 - If an object is reflected clearly in a glass window, then the reflection should be annotated.
 
![instanceseg_reflection](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/instanceseg_reflection.png)
...
![instanceseg_extremity](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/instanceseg_extremity.png)
![instanceseg_extremity_exempt](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/instanceseg_extremity_exempt.png)
...
The following attributes are in **addition** to the [existing ones in VOD]((https://github.com/nutonomy/vod-devkit/tree/master/docs/instructions_vod.md#attributes)):
...
![driveable_1](https://www.vod.org/public/images/taxonomy_imgs/nuimages/driveable_1.png)
![driveable_2](https://www.vod.org/public/images/taxonomy_imgs/nuimages/driveable_2.png)
![driveable_3](https://www.vod.org/public/images/taxonomy_imgs/nuimages/driveable_3.png)
![driveable_4](https://www.vod.org/public/images/taxonomy_imgs/nuimages/driveable_4.png)

### 2. vehicle.ego
![ego_1](https://www.vod.org/public/images/taxonomy_imgs/nuimages/ego_1.png)
![ego_2](https://www.vod.org/public/images/taxonomy_imgs/nuimages/ego_2.png)
![ego_3](https://www.vod.org/public/images/taxonomy_imgs/nuimages/ego_3.png)
![ego_4](https://www.vod.org/public/images/taxonomy_imgs/nuimages/ego_4.png)
...
![surface_no_gaps](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/surface_no_gaps.png)
 - If two areas/objects of interest are adjacent to each other, there should be no gap between the two annotations.
 
![surface_adjacent](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/surface_adjacent.png)
 - Annotate a surface only as far as it is clearly visible.

![surface_far_visible](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/surface_far_visible.png)
...
![surface_occlusion_2](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/surface_occlusion_2.png)
...
![surface_snow](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/surface_snow.png)
...
![surface_occlusion_1](https://www.vod.org/public/images/taxonomy_imgs/nuimages/correct-wrong/surface_occlusion_1.png)
