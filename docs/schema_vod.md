VOD schema
==========
This document describes the database schema used in VOD.
...
category {
   ...
   "index":                   <int> -- The index of the label used for efficiency reasons in the .bin label files of VOD-lidarseg. This field did not exist previously.
}
```
