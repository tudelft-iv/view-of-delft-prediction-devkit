# VOD CAN bus expansion
This page describes the Controller Area Network (CAN) bus expansion for the VOD dataset.
This is additional information that was published in January 2020 after the initial VOD release in March 2019.
...
## Introduction
The VOD dataset provides sensor data and annotations for 1000 scenes.
...
The route is stored as a list of 2-tuples (x, y) in meters on the current VOD map.
...
- pos: \[3\] The position (x, y, z) in meters in the global frame. This is identical to the [VOD ego pose](https://github.com/nutonomy/vod-devkit/blob/master/docs/schema_vod.md#ego_pose), but sampled at a higher frequency.
